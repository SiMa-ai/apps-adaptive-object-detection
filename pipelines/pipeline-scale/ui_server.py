...
Runs ON the DevKit (192.0.2.72), where it can control the detector as a
...
Then open  http://192.0.2.72:8090
...
INSIGHT_UI = "https://192.0.2.10:9900/"   # main Neat Insight UI
