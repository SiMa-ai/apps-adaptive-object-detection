...
// same behaviour for the pipelines toggle to mean anything. H.265 input needs
// Core APIs the board does not have, and nothing here streams H.265.
//
// Definitions live in a header because the build compiles a single translation
// unit (src/cpp/main.cpp). The named namespace keeps these helpers from
// colliding with the other mode's.
#pragma once
